...
if TORCH_AVAILABLE:
    ...
    transform = None
    logger.warning("PyTorch not installed. CNN model will be unavailable.")


def load_model(model_path: str = _DEFAULT_MODEL_PATH, device: str = DEVICE):
    """
    ...
    if not TORCH_AVAILABLE:
        logger.warning("PyTorch not available. Returning None for CNN model.")
        return None
