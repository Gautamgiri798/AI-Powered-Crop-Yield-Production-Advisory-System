...
urlpatterns = [
    ...
    path('api/auth/signup', views.Signup.as_view(), name='signup'),
    path('api/auth/google', views.GoogleLogin.as_view(), name='google_login'),
    path('api/auth/test_token', views.TestToken.as_view(), name='test_token'),
    path('api/auth/password-reset', views.RequestPasswordReset.as_view(), name='password-reset'),
    path('api/auth/password-reset-confirm', views.ResetPassword.as_view(), name='password-reset-confirm'),
